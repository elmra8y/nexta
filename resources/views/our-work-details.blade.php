    ...
    <div class="row">
        <div class="col-xl-4 position-relative">
            <div class="project-details pb-5">
                <h4 class="text-color-primary custom-text-8 font-weight-bold mb-5 appear-animation"
                    data-appear-animation="fadeInRightShorter" data-appear-animation-delay="100">Project Details</h4>
                <ul class="list-unstyled ps-0 pb-0 mb-0">
                    <li class="mb-4 appear-animation" data-appear-animation="fadeInRightShorter"
                        data-appear-animation-delay="200">
                        <span class="text-color-quaternary custom-text-4"><strong
                                    class="text-color-dark">Client: </strong>Okler Themes</span>
                    </li>
                    <li class="mb-4 appear-animation" data-appear-animation="fadeInRightShorter"
                        data-appear-animation-delay="300">
                        <span class="text-color-quaternary custom-text-4"><strong
                                    class="text-color-dark">Year: </strong>2024</span>
                    </li>
                    <li class="mb-4 appear-animation" data-appear-animation="fadeInRightShorter"
                        data-appear-animation-delay="400">
                        <span class="text-color-quaternary custom-text-4"><strong
                                    class="text-color-dark">Timeframe: </strong>6 months</span>
                    </li>
                    <li class="mb-4 appear-animation" data-appear-animation="fadeInRightShorter"
                        data-appear-animation-delay="500">
                        <span class="text-color-quaternary custom-text-4"><strong
                                    class="text-color-dark">Main Service: </strong>UI Design, Web Development</span>
                    </li>
                    <li class="mb-0 appear-animation" data-appear-animation="fadeInRightShorter"
        ...
        <div class="col-xl-8">
            ...
            <p class="custom-text-4 mb-4 appear-animation" data-appear-animation="fadeInRightShorter"
               data-appear-animation-delay="400">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris at massa quam. Maecenas et sem accumsan,
                dictum arcu eu, consectetur eros. Nulla tortor est, lobortis vestibulum turpis sed, mollis commodo orci.
            </p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5 col-xl-6 appear-animation" data-appear-animation="fadeInRightShorter"
                     data-appear-animation-delay="200">
                    <img src="{{asset('/assets/')}}/img/demos/digital-agency-2/gallery/gallery-our-work-1.jpg" class="img-fluid">
                </div>
                <div class="col-md-6 col-lg-5 col-xl-6 pt-4 mt-1 pt-md-0 mt-md-0 appear-animation"
                    ...
                    <img src="{{asset('/assets/')}}/img/demos/digital-agency-2/gallery/gallery-our-work-2.jpg" class="img-fluid">
                </div>
                <div class="col-lg-10 col-xl-12 pt-4 mt-1 appear-animation" data-appear-animation="fadeInRightShorter"
                     data-appear-animation-delay="600">
                    <img src="{{asset('/assets/')}}/img/demos/digital-agency-2/gallery/gallery-our-work-3.jpg" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
