...
@section('content')
        ...
        <div class="row justify-content-between mt-5 mt-xl-0 mb-lg-4">
            <div class="col-xl-4 d-flex flex-column justify-content-end">
                <p class="custom-font-tertiary custom-text-7 mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ut tellus ante. Nam suscipit urna
                    risus.
                </p>
                <p class="custom-text-4 mb-4 appear-animation" data-appear-animation="fadeInRightShorter"
                   data-appear-animation-delay="400">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris at massa quam. Maecenas et sem
                    accumsan, dictum arcu eu, consectetur eros. Nulla tortor est, lobortis vestibulum turpis sed, mollis
                    commodo orci.
                </p>
                <p class="custom-text-4 mb-0 appear-animation" data-appear-animation="fadeInRightShorter"
                   data-appear-animation-delay="600">
                    Sed elementum cursus ante in suscipit. Etiam a arcu consequat, vehicula nisi in, efficitur lectus.
                    Interdum et malesuada fames ac ante ipsum primis in faucibus. In eu lectus ultricies, pellentesque
                    libero vitae, dictum erat.
                </p>
            </div>
            <div class="col-xl-7 py-4 py-xl-0">
                ...
                <ul class="custom-list list-unstyled my-3">
                    <li class="font-weight-medium custom-text-4 mb-4 appear-animation"
                        data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">Porto Digital
                        Agency Bulding, 2024
                    </li>
                </ul>
            </div>
            ...
            <div class="row counters py-5">
                <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                    <div class="counter counter-light" data-appear-animation="fadeInRightShorter"
                        ...
                        <label class="custom-font-tertiary text-color-light custom-text-8 opacity-7 font-weight-normal">Business
                            Year</label>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                    <div class="counter counter-light" data-appear-animation="fadeInRightShorter"
                        ...
                        <label class="custom-font-tertiary text-color-light custom-text-8 opacity-7 font-weight-normal">Satisfied
                            Clients</label>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                    <div class="counter counter-light" data-appear-animation="fadeInRightShorter"
                        ...
                        <label class="custom-font-tertiary text-color-light custom-text-8 opacity-7 font-weight-normal">Projects
                            Delivery</label>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                    <div class="counter counter-light" data-appear-animation="fadeInRightShorter"
                        ...
                        <label class="custom-font-tertiary text-color-light custom-text-8 opacity-7 font-weight-normal">Team
                            Members</label>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-8 d-flex flex-column justify-content-center align-items-start ps-5">
                    ...
                    <p class="custom-text-3 mb-5 appear-animation" data-appear-animation="fadeInRightShorter"
                       data-appear-animation-delay="400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                        imperdiet libero id nisi euismod, sed porta est consectetur. dolor sit amet, consectetur
                        adipiscing elit. Sed imperdiet libero.</p>
                    <a herf="demo-digital-agency-2-contact-us.html"
                       ...
                       data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">Get in Touch</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="our-insights bg-color-tertiary p-relative py-5">
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col">
                    <h4 class="text-color-dark custom-text-10 font-weight-bold text-center custom-title-with-icon-center custom-title-with-icon custom-title-with-icon-primary pb-5 mb-5 appear-animation"
                        data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">Our Insights</h4>
                </div>
            </div>
            <div class="row">
                <div class="col pb-5">
                    <article>
                        ...
                        <p class="custom-text-4 mb-2 appear-animation" data-appear-animation="fadeInRightShorter"
                           data-appear-animation-delay="600">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Sed imperdiet libero id nisi euismod, sed porta est consectetur. dolor sit amet, consectetur
                            adipiscing elit. Sed imperdiet libero.</p>
                        <a href="#."
                           ...
                           data-appear-animation="fadeInRightShorter" data-appear-animation-delay="800">Read More...</a>
                    </article>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col">
                    <a herf="demo-digital-agency-2-our-blog.html"
