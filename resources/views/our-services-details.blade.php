...
@section('content')
    ...
    <section
            class="get-in-touch bg-coalor-after-secondary overlay overlay-color-primary overlay-show p-relative overflow-hidden"
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <h4 class="text-color-light font-weight-bold custom-text-10 appear-animation"
                        ...
                        {{__('We’re interested in talking')}}
                        <br/>
                ...
                <div class="col-lg-4 d-flex align-items-center justify-content-start justify-content-lg-end mt-5 mt-lg-0">
                    <a herf="#"
                       ...
                       data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="600"> {{__('Let’s Talk!')}}</a>
                </div>
            </div>
        </div>
    </section>
