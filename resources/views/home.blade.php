            ...
            <div class="row pb-lg-5 mt-5 mb-lg-5">
                <div class="col-lg-7 pt-5 pt-md-0 pb-lg-5 mt-5 mb-md-5">
                    <h2 class="custom-title-with-icon custom-title-with-icon-primary font-weight-normal text-color-default text-5 mb-0 appear-animation"
                        data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="600">Welcome to
                        the Age of Digital Transformation</h2>
                    <h1 class="text-color-light font-weight-extra-bold text-10 text-md-12-13 line-height-2 mb-4 appear-animation"
                        data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="850">Experience
                        Design and Intelligent Marketing.</h1>
        ...
        <div class="row">
                ...
                <div class="card border-0 bg-color-dark rounded-0 z-index-1 p-5 appear-animation"
                    ...
                    <div class="card-body d-flex flex-column justify-content-center align-items-center p-0 my-3">
                        ...
                        <h4 class="card-title custom-text-8 font-weight-bold text-color-light text-center mb-3">
                            Growth Marketing</h4>
                        <p class="card-text text-center custom-text-4 font-weight-lighter">Driving sustainable growth
                            through data-driven marketing strategies and targeted customer engagement techniques.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-custom-cards">
                <div class="card border-0 bg-color-primary rounded-0 z-index-1 p-5 appear-animation"
                    ...
                    <div class="card-body d-flex flex-column justify-content-center align-items-center p-0 my-3">
                        ...
                        <p class="card-text text-center custom-text-4 font-weight-lighter text-color-light">
                            Delivering innovative web solutions to empower software houses with cutting-edge, scalable
                            technologies.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-custom-cards">
                <div class="card border-0 bg-color-dark rounded-0 z-index-1 p-5 appear-animation"
                    ...
                    <div class="card-body d-flex flex-column justify-content-center align-items-center p-0 my-3">
                        <img src="{{asset('/assets/')}}/img/demos/digital-agency-2/icons/feedback.png" alt="Solution" class="mb-5">
                        <h4 class="card-title custom-text-8 font-weight-bold text-color-light text-center mb-3">
                            Digital Marketing</h4>
                        <p class="card-text text-center custom-text-4 font-weight-lighter">Empowering brands with
                            innovative digital marketing strategies to drive engagement, conversion, and growth.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-xl-4 d-flex flex-column justify-content-center align-items-start">
                <h4 class="custom-text-10 mb-4 pb-2 font-weight-bold custom-title-with-icon custom-title-with-icon-primary appear-animation"
                    data-appear-animation="fadeInRightShorter" data-appear-animation-delay="100">Our
                    Approach</h4>
                <p class="custom-font-tertiary custom-text-6 line-height-6 font-weight-medium appear-animation"
                   data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
                    At Nexta, we approach every project with a commitment to innovation and close collaboration.
                    By understanding our clients' needs, we create solutions that are both functional and
                    user-friendly. Our team uses cutting-edge technology and best practices to deliver
                    high-quality, future-ready products.
                </p>
                <p class="custom-text-3 appear-animation" data-appear-animation="fadeInRightShorter"
                   data-appear-animation-delay="400">
                    We prioritize transparency and agility, adapting quickly to new insights and trends. This
                    allows us to build scalable solutions that evolve with our clients' needs. At Nexta, our
                    goal is to empower businesses through tools that drive growth and efficiency.
                </p>
            </div>
            ...
            <div class="col-lg-6 col-xl-4 d-flex align-items-center mt-4 mt-lg-0">
                <ul class="custom-list list-unstyled ms-xl-2 ps-xl-1">
                    ...
                    <li class="font-weight-medium custom-text-4 appear-animation"
                        ...
                        Agility and Transparency Focus
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <h4 class="text-color-dark custom-text-10 font-weight-bold text-center custom-title-with-icon-center custom-title-with-icon custom-title-with-icon-primary pb-5 mb-4 appear-animation"
                data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">We Can Help You
                With:</h4>
        </div>
        <div class="row">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-9">
                <p class="custom-text-4 mt-4 mb-0 text-center appear-animation"
                   data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
                    At Nexta, our goal is to provide comprehensive, reliable support tailored to
                    your unique business needs. We’re more than just a service provider; we’re a partner
                    invested in your success. From the initial planning stages through to implementation and
                    ongoing maintenance, we ensure each solution is crafted with precision and scalability in
                    mind. Our experienced team leverages the latest technologies and best practices to help you
                    stay competitive, grow your brand, and achieve long-term results. Trust us to deliver
                    solutions that drive innovation and empower your business to thrive in today’s digital
                    landscape.
                </p>
            </div>
        </div>
